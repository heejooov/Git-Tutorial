...
public class join extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l_preg=(LinearLayout)findViewById(R.id.l_pregnant);
        l_baby=(LinearLayout)findViewById(R.id.l_baby);
        l_stud=(LinearLayout)findViewById(R.id.l_student);
        l_adult=(LinearLayout)findViewById(R.id.l_adult);
        l_middle=(LinearLayout)findViewById(R.id.l_middle);
        l_old=(LinearLayout)findViewById(R.id.l_old);
        l_disa=(LinearLayout)findViewById(R.id.l_disable);
        l_one=(LinearLayout)findViewById(R.id.l_oneparent);
        l_multi=(LinearLayout)findViewById(R.id.l_multiculture);
        l_low=(LinearLayout)findViewById(R.id.l_lowmoney);

        tv_preg=(TextView)findViewById(R.id.tv_pregnant);
        tv_baby=(TextView)findViewById(R.id.tv_baby);
        tv_stud=(TextView)findViewById(R.id.tv_student);
        tv_adult=(TextView)findViewById(R.id.tv_adult);
        tv_middle=(TextView)findViewById(R.id.tv_middle);
        tv_old=(TextView)findViewById(R.id.tv_old);
        tv_disa=(TextView)findViewById(R.id.tv_disable);
        tv_one=(TextView)findViewById(R.id.tv_oneparent);
        tv_multi=(TextView)findViewById(R.id.tv_multiculture);
        tv_low=(TextView)findViewById(R.id.tv_lowmoney);

        i_preg=(ImageView)findViewById(R.id.i_pregnant);
        i_baby=(ImageView)findViewById(R.id.i_baby);
        i_stud=(ImageView)findViewById(R.id.i_student);
        i_adult=(ImageView)findViewById(R.id.i_adult);
        i_middle=(ImageView)findViewById(R.id.i_middle);
        i_old=(ImageView)findViewById(R.id.i_old);
        i_disa=(ImageView)findViewById(R.id.i_disable);
        i_one=(ImageView)findViewById(R.id.i_oneparent);
        i_multi=(ImageView)findViewById(R.id.i_multiculture);
        i_low=(ImageView)findViewById(R.id.i_lowmoney);
